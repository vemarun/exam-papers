...
<script>(function(d, s, id) {
  ...
  <ul class="navigation">
    ...
    <li class="nav-item"><a href="studymat.php">study material</a></li>
</ul>
...
<center><b>Study Materials:<br><p>&nbsp;</p>

<?php
$dir_open = opendir('books/studymaterial');
   while(false !== ($filename = readdir($dir_open))){
        if($filename != "." && $filename != ".."){
        $link = "<a href='books/studymaterial/$filename'> $filename </a><br /><p>&nbsp;</p>";
        echo $link;
    }
}
...
?>
    ...
    <div class="fb-comments" data-href="http://developers.facebook.com/docs/plugins/khichpichstudy/" data-width="1020" data-numposts="5" data-colorscheme="light"></div> 
    <div class="footer">
<ul class="footer">
